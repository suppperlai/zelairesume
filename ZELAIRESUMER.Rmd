...
- <i class="fa fa-envelope"></i>zzhang25@tufts.edu
- <i class="fa fa-github"></i> [github.com/suppperlai](https://github.com/suppperlai/zelairesume.git)
- <i class="fa fa-phone"></i> +1 513-331-0501
